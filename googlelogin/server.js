...
const UserService = require("../googlelogin/googlefile/user");

require("../googlelogin/googlefile/config/passpoer");
require("../googlelogin/googlefile/config/local");
require("../googlelogin/googlefile/config/google");
